                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('dateOfBirth') ? ' has-error' : '' }} col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label for="dateOfBirth" class="col-lg-6 col-md-6 col-sm-6 col-xs-12 control-label">Año de nacimiento</label>

                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                                <select id="dateOfBirth" class="form-control" name="dateOfBirth" value="{{ old('dateOfBirth') }}" required autofocus>
